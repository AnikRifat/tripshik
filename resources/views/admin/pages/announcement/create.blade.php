    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{route('store.announcement')}}" method="post" enctype="multipart/form-data">
                @csrf
                <h5 class="font-size-14 mb-4"><i class="mdi mdi-plus text-primary me-1"></i>Add Announcement</h5>
                ...
                <div class="row">
                    ...
                    <input type="text" hidden name="date" value="{{ date('j F,Y') }}">
                    <div class="col-lg-12">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="details" id="details"
                              placeholder="announcement Answere">
